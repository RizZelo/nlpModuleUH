...
export default function EnhancedCVAnalyzer() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // Set editable text (use full_text from backend)
      const cvText = data.cv_stats?.full_text || '';
      setEditableHTML(`<div style="white-space: pre-wrap; font-family: monospace;">${cvText}</div>`);
